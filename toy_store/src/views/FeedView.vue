    ...
    <div class="container">
      <div class="products__article">
        ...
        <div class="product-catalog__grip" style="width: 100%; margin-top: 10px;">
          <div class="feed-preview" v-for="feed in feedList" :key="feed.id" style="margin-bottom: 10px; width: 100%; border-radius: 20px; display: flex; justify-content: space-between; align-items: center; background-color: white; padding: 10px;">
...
import SliderSale from "@/components/SliderSale.vue";

export default {
  name: "FeedView",
  components: {SliderSale, UpButtonPage},
  methods: {
    loadFeeds() {
